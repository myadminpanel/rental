                                                  ...
                                                  <div class="carousel-inner car-inn-1">
													<?php 												
														...
														<?php 
															...
															if(in_array($set_months_final_to[1],array($target_date[1]))){																
																$active_to = 'active';
																$acty_to = "acty-1";							
															} ?>                                                      
                                          ...
                                          <div class="col-md-8 col-md-offset-2">
                                              <div class="carousel slide" data-ride="carousel" data-type="multi" data-interval="30000000" id="myCarouselh1">
                                                  <div class="carousel-inner car-inn-1 car-inn-2">
														  <?php 													
															foreach(Current_date_runner($target_date[4],$target_date[5])as $datewday_to){ 
																$acty2_to = '';
																$active_to="";
																$datearray_to=explode ('-',$datewday_to);			
															if(in_array($datearray_to[2],array($target_date[2]))){	  
																$active_to = 'active';
																$acty2_to = "acty-2";
																}
																	?>

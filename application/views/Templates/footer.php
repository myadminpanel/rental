		...
		<div class="footer-main">
			<div class="col-lg-12">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
					...
					<ul>
						<li><a href="javascript:void(0);"><?php if($this->lang->line('home_slide_H4')): ?><?php echo $this->lang->line('home_slide_H4'); else: ?> How Rent -A- Car Works<?php endif; ?></a></li>
						...
						<li><a href="javascript:void(0);"><?php if($this->lang->line('home_slide_H6')): ?><?php echo $this->lang->line('home_slide_H6'); else: ?>Rent -A- Car in Safety<?php endif; ?></a></li>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
					...
					<ul>
					   <li><a href="javascript:void(0);"><?php if($this->lang->line('home_slide_H10')): ?><?php echo $this->lang->line('home_slide_H10'); else: ?>Rent -A- Car Team<?php endif; ?></a></li>
						...
						<li><a href="javascript:void(0);"><?php if($this->lang->line('home_slide_H13')): ?><?php echo $this->lang->line('home_slide_H13'); else: ?>Rent -A- Car Blog<?php endif; ?></a></li>
			...
			<div class="col-lg-12">
				<h5 class="col-lg-12"><?php if($this->lang->line('home_slide_H19')): ?><?php echo $this->lang->line('home_slide_H19'); else: ?>© Copyright © 2017-2018 Ahsan Solutions. All rights reserved.<?php endif; ?></h5>
			</div>
		</div>
	</div>
</footer>

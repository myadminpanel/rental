            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <div class="logo">
                            <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/home/1.png" alt="logo" /></a>
                        </div>
                    </div>
                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                               ...
                               <ul class="nav navbar-nav nav-ul-sub">
                                    ...
                                    <li><a href="javascript:void(0);"><?php if($this->lang->line('mobileapp')): ?><?php echo $this->lang->line('mobileapp'); ?><?php else: ?>Mobile App<?php endif; ?></a></li>
                                    <li><a href="javascript:void(0);"><?php if($this->lang->line('partnerwithus')): ?><?php echo $this->lang->line('partnerwithus'); ?><?php else: ?>Partnerwithus<?php endif; ?></a></li>
							...
							<?php else: ?>
                                    <li><a href="javascript:void(0);" data-toggle="modal" class="login-signup-cityride" data-target="#myModallogin"><?php if($this->lang->line('signup')): ?><?php echo $this->lang->line('signup'); ?><?php else: ?>Signup<?php endif; ?></a></li>
        ...
        <div class="banner-landing">
            <div class="container">
                <div class="landing-content">
                    <h1 class="animated fadeInDown"><?php if($this->lang->line('home_slide_A1')): ?><?php echo $this->lang->line('home_slide_A1'); else: ?>DRIVE IN THE CITY & <?php endif; ?></h1>
                    <h2 class="animated fadeInDown"><?php if($this->lang->line('home_slide_A2')): ?><?php echo $this->lang->line('home_slide_A2'); else: ?>OUTSTATION<?php endif; ?></h2>

                    <h3 class="animated fadeInDown"><span class="h3-land-span">
                         <span class="dk-1 animated fadeInRight"><img src="<?php echo base_url(); ?>assets/img/home/2.png" /> </span>
                        <?php if($this->lang->line('home_slide_A3')): ?><?php echo $this->lang->line('home_slide_A3'); else: ?>When do you need a CityRide?<?php endif; ?><span class="dk-2 bookingPopup kickup" id="kickup" data-toggle="modal" data-target="#myModalz"><img src="<?php echo base_url(); ?>assets/img/home/5.png" />
                    </span>
                    </span></h3>
                </div>
            </div>
            <div class="zoom-pop-down-1">
                <div class="cit-main">
                    <h4><?php if($this->lang->line('home_slide_A4')): ?><?php echo $this->lang->line('home_slide_A4'); else: ?>Rent a Self-Drive car in <?php endif; ?></h4><h4 class="fix-locdrum"></h4>
                ...
                <div class="zoom-pop-down">
                    <div class="container">                        
						<!-- ====Slider Start======= -->
			    		<div class="city-sel">
			    			<h3><?php if($this->lang->line('home_slide_A5')): ?><?php echo $this->lang->line('home_slide_A5'); else: ?>SELECT YOUR CITY<?php endif; ?></h3>
			    			<div class="col-lg-12">
							  	<div class="bxslider">

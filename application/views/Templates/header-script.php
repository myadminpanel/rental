...
<meta charset="UTF-8">
	<title>Ahsan - Rent - A - Car</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link rel="icon" href="<?php echo base_url(); ?>admin/<?php echo get_settings()->favicon; ?>" type="image/jpg" sizes="16x16">
...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/developer-settings.css">

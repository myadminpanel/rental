...
<div class="col-lg-12">
    <div class="offer-1">
        <h2><?php if($this->lang->line('webname')): ?><?php echo $this->lang->line('webname'); else: ?>AHSAN<?php endif; ?> <?php if($this->lang->line('offers_slide_A1')): ?><?php echo $this->lang->line('offers_slide_A1'); else: ?>OFFERS FOR BANGALORE<?php endif; ?>  <span class="fix-locdrum"></span></h2>
    </div>
</div>
    <div class="col-lg-12">
        <div class="offer-2">

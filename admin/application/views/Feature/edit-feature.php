         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Edit Feature Details</h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
                  ...
                  <div class="box-body">                 
                     <div class="col-md-6">
					      <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control required" value="<?php echo $data->name; ?>" data-parsley-trigger="change" data-parsley-minlength="4" required="" name="name"  placeholder="Feature">

         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title"> Add Fuel Details</h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
				  ...
				  <div class="box-body">                 
                     <div class="col-md-12">
					      <div class="form-group has-feedback">
							...
							data-parsley-trigger="change" data-parsley-pattern="^[a-zA-Z\  \/-]+$"  required=""  name="name"  placeholder="Car Fuel Type">
                  ...
                  <table id="" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="center">	                         	 
                              <a class="btn btn-sm btn-primary" href="<?php echo base_url();?>Fuel/edit/<?php echo $feature->id; ?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>  
							  <a class="btn btn-sm btn-danger" href="<?php echo base_url();?>Fuel/deletefuel/<?php echo $feature->id; ?>" onClick="return doconfirm()">
